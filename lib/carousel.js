...
var Carousel = _react2['default'].createClass({
  ...
  propTypes: {
    ...
    decorators: _react.PropTypes.arrayOf(_react.PropTypes.shape({
      component: _react.PropTypes.func,
      position: _react.PropTypes.oneOf(['TopLeft', 'TopCenter', 'TopRight', 'CenterLeft', 'CenterCenter', 'CenterRight', 'BottomLeft', 'BottomCenter', 'BottomRight']),
    ...
    frameOverflow: _react.PropTypes.string,
    ...
    swiping: _react.PropTypes.bool,
    vertical: _react.PropTypes.bool,
    width: _react.PropTypes.string,
    wrapAround: _react.PropTypes.bool
  },
